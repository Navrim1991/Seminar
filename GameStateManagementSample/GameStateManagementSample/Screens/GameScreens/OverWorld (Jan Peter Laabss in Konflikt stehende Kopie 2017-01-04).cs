...
namespace GameStateManagement.Screens.GameScreens
{
    class OverWorld : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            movingGameObjects.Add(new NPC(ref contentManagerNpc, new List<string>() { "katze_2" }, GameObjectID.Npc, GameObjectOption.Attackable, new Vector2(199, 500), game,
                Config.ConfigNpcEvade, AI.AiOption.CHASE)) ;

            movingGameObjects.Add(new NPC(ref contentManagerNpc, new List<string>() { "hexe_stand_bewegung_rechts" }, GameObjectID.Npc, GameObjectOption.Attackable, new Vector2(199, 800), game,
                Config.ConfigNpcEvade, AI.AiOption.CHASE));

            movingGameObjects.Add(new NPC(ref contentManagerNpc, new List<string>() { "knochen_1" }, GameObjectID.Npc, GameObjectOption.Attackable, new Vector2(500, 800), game,
                Config.ConfigNpcEvade, AI.AiOption.CHASE));
        ...
        public override void Update(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen)
        {
            ...
            if (this.IsActive)
            {
                ...
                //waffe 340, 500
                if (player.Coordinates.X <= 368 && player.Coordinates.X >= 316 && player.Coordinates.Y <= 510 && player.Coordinates.Y >= 464)
                {
                    notMovingGameObjects.Remove(bogen);
                    bogenbool = 1;
                }
                //bogen 340,550
                if (player.Coordinates.X <= 360 && player.Coordinates.X >= 310 && player.Coordinates.Y <= 585 && player.Coordinates.Y >= 525)
                {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            foreach(NotMovingGameObject element in notMovingGameObjects)
            {
                ...
                if(element is House)
                {
                    ...
                    if(house.EntryRec != null && house.EntryRec != new Rectangle(0,0,0,0))
                        spriteBatch.DrawString(spriteFontArial, element.Coordinates.ToString(), new Vector2(element.Coordinates.X, element.Coordinates.Y - 50), Color.Red);
                }
